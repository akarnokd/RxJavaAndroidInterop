...
public final class AndroidSchedulers {
    ...
    private static final Scheduler MAIN_THREAD = AndroidInteropPlugins.initMainThreadScheduler(
    ...
    public static Scheduler mainThread() {
        return AndroidInteropPlugins.onMainThreadScheduler(MAIN_THREAD);
    }
